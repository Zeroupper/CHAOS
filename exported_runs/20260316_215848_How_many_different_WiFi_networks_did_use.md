...
**Understanding:** Count the number of unique WiFi SSIDs (networks) that user test004 connected to based on the ios_wifi dataset.

| Step | Action | Source |
|------|--------|--------|
| 1 | Filter ios_wifi dataset where uid = 'test004' | ios_wifi |
| 2 | Get count of distinct ssid values from filtered results | ios_wifi |
