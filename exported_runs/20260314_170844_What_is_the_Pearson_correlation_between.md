...
| Step | Action | Source |
|------|--------|--------|
| 1 | Load pre dataset and select pid and PSS_10items_PRE columns | pre |
| 2 | Load sleep dataset and select pid, date, and f_slp:fitbit_sleep_summary_rapids_avgdurationasleepmain:14dhist columns | sleep |
| 3 | Group sleep data by pid and calculate mean of f_slp:fitbit_sleep_summary_rapids_avgdurationasleepmain:14dhist per participant | step_2_result |
| 4 | Merge pre-study data with aggregated sleep data on pid (inner join to include only participants in both datasets) | step_1_result, step_3_result |
| 5 | Calculate Pearson correlation between PSS_10items_PRE and average sleep duration, round to 4 decimal places | step_4_result |

## Execution Log


**Sensemaker Request:** Load pre dataset and select pid and PSS_10items_PRE columns
...
**Sensemaker Request:** Load sleep dataset and select pid, date, and f_slp:fitbit_sleep_summary_rapids_avgdurationasleepmain:14dhist columns
...
**Sensemaker Request:** Group sleep data by pid and calculate mean of f_slp:fitbit_sleep_summary_rapids_avgdurationasleepmain:14dhist per participant
...
**Sensemaker Request:** Merge pre-study data (step_1_result) with aggregated sleep data (step_3_result) on pid using inner join
...
**Sensemaker Request:** Calculate Pearson correlation between PSS_10items_PRE and f_slp:fitbit_sleep_summary_rapids_avgdurationasleepmain:14dhist from step_4_result, round to 4 decimal places
...
```
-0.1511 (Pearson correlation between pre-study PSS-10 stress scores and average 14-day rolling sleep duration).
```
