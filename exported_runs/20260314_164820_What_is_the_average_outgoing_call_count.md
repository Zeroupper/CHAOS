...
**Understanding:** Calculate the mean of outgoing call counts from the call dataset, excluding null values, and round the result to 4 decimal places.

| Step | Action | Source |
|------|--------|--------|
| 1 | Load call dataset | call |
| 2 | Select outgoing call count column f_call:phone_calls_rapids_outgoing_count:14dhist | step_1_result |
| 3 | Calculate mean ignoring null values | step_2_result |
| 4 | Round result to 4 decimal places | step_3_result |

## Execution Log


**Sensemaker Request:** Load call dataset from call
...
**Sensemaker Request:** Select column f_call:phone_calls_rapids_outgoing_count:14dhist from step_1_result
...
**Sensemaker Request:** Calculate mean of step_2_result excluding null values
...
**Sensemaker Request:** Round step_3_result to 4 decimal places
