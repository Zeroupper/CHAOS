...
**Understanding:** Find the maximum heart rate value from heart rate monitoring data across the dataset

| Step | Action | Source |
|------|--------|--------|
| 1 | Select heart_rate from garmin_hr dataset | garmin_hr |
| 2 | Select heart_rate from garmin_stress dataset | garmin_stress |
| 3 | Calculate maximum heart_rate value across both datasets | garmin_hr,garmin_stress |

## Execution Log


**Sensemaker Request:** Select heart_rate from garmin_hr dataset
...
**Sensemaker Request:** Select heart_rate from garmin_stress dataset (from garmin_stress)
...
**Sensemaker Request:** Calculate maximum heart_rate value by combining heart_rate columns from both garmin_hr and garmin_stress datasets
