...
**Understanding:** Identify the maximum value in the heart_rate column from the garmin_hr dataset.

| Step | Action | Source |
|------|--------|--------|
| 1 | Extract heart_rate values from garmin_hr dataset | garmin_hr |
| 2 | Compute maximum value from step_1_result | step_1_result |

## Execution Log


**Sensemaker Request:** Extract heart_rate values from garmin_hr dataset
...
**Sensemaker Request:** Compute maximum value from step_1_result
...
```
155.0 (maximum value in the heart_rate column from the garmin_hr dataset)
```
