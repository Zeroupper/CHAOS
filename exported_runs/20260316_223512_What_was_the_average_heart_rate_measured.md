...
**Understanding:** Find the average heart rate from garmin_stress dataset where user is test004 and status is VALID

| Step | Action | Source |
|------|--------|--------|
| 1 | Filter garmin_stress table where uid = 'test004' and status = 'VALID' | garmin_stress |
| 2 | Calculate average of heart_rate column from filtered data | step_1_result |

## Execution Log


**Sensemaker Request:** Filter garmin_stress table where uid = 'test004' and status = 'VALID'
...
**Sensemaker Request:** Calculate average of heart_rate column from step_1_result
...
```
54.49 (average heart rate for user test004 with VALID status)
```
