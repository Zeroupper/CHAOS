...
| Step | Action | Source |
|------|--------|--------|
| 1 | Extract pid and PSS_10items_PRE from pre dataset | pre |
| 2 | Calculate average f_slp:fitbit_sleep_summary_rapids_sumdurationasleepmain:14dhist per pid from sleep dataset, grouping by pid | sleep |
| 3 | Join step_1_result and step_2_result on pid (inner join to include only participants in both datasets) | step_1_result, step_2_result |
...
**Sensemaker Request:** Extract pid and PSS_10items_PRE from pre dataset
...
**Sensemaker Request:** Calculate average f_slp:fitbit_sleep_summary_rapids_sumdurationasleepmain:14dhist per pid from sleep dataset, grouping by pid
...
**Sensemaker Request:** Join step_1_result and step_2_result on pid (inner join to include only participants in both datasets)
...
**Sensemaker Request:** Calculate Pearson correlation between PSS_10items_PRE and average sleep duration (f_slp:fitbit_sleep_summary_rapids_sumdurationasleepmain:14dhist), round to 4 decimal places
...
```
-0.1096 (Pearson correlation between pre-study PSS-10 perceived stress and average 14-day rolling total sleep duration).
```
