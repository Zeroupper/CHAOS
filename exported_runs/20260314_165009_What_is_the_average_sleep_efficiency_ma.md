...
| Step | Action | Source |
|------|--------|--------|
| 1 | Filter sleep dataset for pid = 'INS-W_009' and select f_slp:fitbit_sleep_summary_rapids_avgefficiencymain:14dhist column, excluding null values | sleep |
| 2 | Calculate the mean of f_slp:fitbit_sleep_summary_rapids_avgefficiencymain:14dhist from step_1_result | step_1_result |

## Execution Log


**Sensemaker Request:** Filter sleep dataset for pid = 'INS-W_009' and select f_slp:fitbit_sleep_summary_rapids_avgefficiencymain:14dhist column, excluding null values
...
**Sensemaker Request:** Calculate the mean of the values from step_1_result, which are the sleep efficiency percentages for participant INS-W_009
...
```
92.55083021916354 (Average 14-day rolling sleep efficiency for participant INS-W_009 from 1587 observations)
```
