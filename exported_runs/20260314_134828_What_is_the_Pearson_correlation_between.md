...
**Understanding:** Need to calculate Pearson correlation between PSS_10items_PRE from pre dataset and sleep duration (sumdurationasleepmain:14dhist) from sleep dataset. Must join on pid to ensure only participants in both datasets are included.

| Step | Action | Source |
|------|--------|--------|
| 1 | Extract pid and PSS_10items_PRE from pre dataset | pre |
| 2 | Extract pid and f_slp:fitbit_sleep_summary_rapids_sumdurationasleepmain:14dhist from sleep dataset, then aggregate by pid to get average sleep duration per participant | sleep |
| 3 | Inner join step_1_result and step_2_result on pid to keep only participants present in both datasets | step_1_result, step_2_result |
...
**Sensemaker Request:** Extract pid and f_slp:fitbit_sleep_summary_rapids_sumdurationasleepmain:14dhist from sleep dataset, then aggregate by pid to get average sleep duration per participant
...
**Sensemaker Request:** Inner join step_1_result and step_2_result on pid to keep only participants present in both datasets
...
```
-0.1096 (Pearson correlation between PSS_10items_PRE and sleep duration from 5392 participants)
```
