...
**Understanding:** Find the maximum heart rate value from heart rate monitoring data

| Step | Action | Source |
|------|--------|--------|
| 1 | Select garmin_hr dataset and extract heart_rate column | garmin_hr |
| 2 | Calculate maximum value from heart_rate column | - |

## Execution Log


**Sensemaker Request:** SELECT garmin_hr dataset and extract heart_rate column
...
**Sensemaker Request:** max_hr = garmin_hr['heart_rate'].max()
...
```
155.0, the maximum heart rate value from the monitoring data.
```
