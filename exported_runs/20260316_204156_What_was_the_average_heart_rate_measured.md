...
**Understanding:** Need to calculate average heart_rate from garmin_stress dataset where uid='test004' and status='VALID'

| Step | Action | Source |
|------|--------|--------|
| 1 | Select from garmin_stress where uid='test004' and status='VALID' | garmin_stress |
| 2 | Calculate AVG(heart_rate) from filtered results | step_1_result |
...
**Sensemaker Request:** Calculate AVG(heart_rate) from the filtered results of step_1_result using garmin_stress column heart_rate
...
```
54.485022618902065 (Average heart_rate from 1165264 filtered records where uid='test004' and status='VALID')
```
