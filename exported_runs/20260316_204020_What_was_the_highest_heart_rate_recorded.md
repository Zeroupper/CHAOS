...
**Understanding:** The user wants to know the maximum heart rate value from all heart rate recordings in the dataset.

| Step | Action | Source |
|------|--------|--------|
| 1 | SELECT heart_rate FROM garmin_hr | garmin_hr |
| 2 | ORDER BY heart_rate DESC LIMIT 1 | garmin_hr |
| 3 | Extract the maximum heart_rate value as result | garmin_hr |
...
**Sensemaker Request:** ORDER BY heart_rate DESC LIMIT 1 (from garmin_hr)
...
**Result:**
```
{"_id":{"8126":"68b1363e9a3dce0ff56040c1"},"uid":{"8126":"test004"},"event_id":{"8126":442},"timestamp":{"8126":1756436355},"heart_rate":{"8126":155.0},"status":{"8126":"SEARCHING"}}
```


**Sensemaker Request:** Extract maximum heart rate value from step_2_result
...
```
155.0 (maximum heart rate from all recordings in the dataset)
```
