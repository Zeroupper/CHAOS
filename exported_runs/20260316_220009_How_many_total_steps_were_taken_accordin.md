...
**Understanding:** Calculate the sum of all step counts from the Garmin fitness tracker data to find the total number of steps recorded.

| Step | Action | Source |
|------|--------|--------|
| 1 | Load the garmin_steps dataset and filter out any rows with null total_steps values | garmin_steps |
| 2 | Sum the total_steps column to calculate the cumulative total number of steps taken | step_1_result |

## Execution Log


**Sensemaker Request:** Load the garmin_steps dataset and filter out any rows with null total_steps values
...
**Sensemaker Request:** Calculate the sum of the 'total_steps' column from step_1_result
