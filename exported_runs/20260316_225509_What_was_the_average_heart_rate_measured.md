...
**Understanding:** Calculate the average heart_rate from garmin_stress dataset where status is 'VALID' and uid is 'test004'.

| Step | Action | Source |
|------|--------|--------|
| 1 | Filter garmin_stress dataset for rows where uid='test004' and status='VALID' | garmin_stress |
| 2 | Compute average of heart_rate column from filtered results | step_1_result |

## Execution Log


**Sensemaker Request:** Filter garmin_stress dataset for rows where uid='test004' and status='VALID'
...
**Sensemaker Request:** Compute average of heart_rate column from step_1_result
...
```
54.485022618902065 (average heart_rate from garmin_stress dataset where status is 'VALID' and uid is 'test004')
```
