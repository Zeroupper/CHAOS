...
**Understanding:** Count the unique number of distinct applications that were used, based on the app_usage_logs dataset which tracks appName for each device usage event.

| Step | Action | Source |
|------|--------|--------|
| 1 | Select the appName column from app_usage_logs dataset | app_usage_logs |
| 2 | Count the distinct values in the appName column | app_usage_logs |

## Execution Log


**Sensemaker Request:** Select the appName column from the app_usage_logs dataset
...
**Sensemaker Request:** Count the distinct values in the appName column from app_usage_logs
