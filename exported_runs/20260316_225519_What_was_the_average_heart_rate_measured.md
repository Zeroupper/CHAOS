...
**Understanding:** Calculate the average heart_rate from garmin_stress dataset where uid='test004' and status='VALID'

| Step | Action | Source |
|------|--------|--------|
| 1 | Filter garmin_stress dataset for uid='test004' | garmin_stress |
| 2 | Filter step_1_result for status='VALID' | step_1_result |
| 3 | Calculate average of heart_rate column from step_2_result | step_2_result |

## Execution Log


**Sensemaker Request:** Filter garmin_stress dataset where uid='test004'
...
**Sensemaker Request:** Filter step_1_result for status='VALID'
...
**Sensemaker Request:** Calculate average of heart_rate column from step_2_result
