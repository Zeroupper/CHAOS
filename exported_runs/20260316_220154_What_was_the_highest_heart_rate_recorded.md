...
**Understanding:** Find the maximum heart rate value from heart rate monitoring data in the dataset.

| Step | Action | Source |
|------|--------|--------|
| 1 | SELECT heart_rate FROM garmin_hr | garmin_hr |
| 2 | SELECT heart_rate FROM garmin_stress WHERE heart_rate IS NOT NULL | garmin_stress |
| 3 | CONCATENATE results from garmin_hr and garmin_stress steps and find MAX(heart_rate) | Combined |
| 4 | Return the maximum heart rate value | Result |
...
**Sensemaker Request:** SELECT heart_rate FROM garmin_stress WHERE heart_rate IS NOT NULL
...
**Sensemaker Request:** Combine the heart_rate results from step_1_result and step_2_result into a single list/array, then calculate the maximum value using max(). Store the result in a variable for step 4 to return.
...
**Sensemaker Request:** Return the maximum heart rate value (155.0) as the final answer
...
```
155.0 (maximum heart rate value from combined Garmin heart rate monitoring data)
```
