...
**Understanding:** Count the number of unique WiFi network SSIDs that user test004's phone connected to

| Step | Action | Source |
|------|--------|--------|
| 1 | Filter the ios_wifi dataset where uid = 'test004' | ios_wifi |
| 2 | Count distinct values in the ssid column to get number of different WiFi networks | ios_wifi |

## Execution Log


**Sensemaker Request:** Filter the ios_wifi dataset where uid = 'test004' using: ios_wifi[ios_wifi.uid == 'test004']
...
**Sensemaker Request:** Count distinct values in the ssid column: ios_wifi['ssid'].nunique()
...
```
4 (user test004 connected to 4 unique WiFi network SSIDs)
```
